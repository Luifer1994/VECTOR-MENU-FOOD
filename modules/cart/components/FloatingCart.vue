...
<template>
    <div>
        ...
        <!-- Overlay -->
        <div v-if="isOpen" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-40 transition-opacity"
            @click="closeDrawer"></div>

        <!-- Cart Drawer -->
        <div v-if="isOpen"
            class="fixed right-0 top-0 h-full w-full sm:w-[450px] bg-card shadow-2xl z-50 flex flex-col transform transition-transform duration-300 ease-out">
